...
void TrainingAlgorithm::set_first_training_rate(double new_first_training_rate)
{
   ...
   {
	  TRACE0("Flood Error: TrainingAlgorithm class.\n");
	  TRACE0("void set_first_training_rate(double) method.\n");
	  TRACE0("First training rate must be equal or greater than 0.\n");
      exit(1);
   }
