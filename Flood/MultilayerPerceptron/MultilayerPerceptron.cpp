...
void MultilayerPerceptron::set_hidden_layer_activation_function(int index)
{
	switch (index)   //Logistic  HyperbolicTangent   Linear
	{
	case 0:
		hidden_layers_activation_function[0] = MultilayerPerceptron::Logistic;
	/*	hidden_layers_activation_function[1] = MultilayerPerceptron::Logistic;*/
		break;
	case 1:
		hidden_layers_activation_function[0] = MultilayerPerceptron::HyperbolicTangent;
	/*	hidden_layers_activation_function[1] = MultilayerPerceptron::HyperbolicTangent;*/
		break;
	case 2:
		hidden_layers_activation_function[0] = MultilayerPerceptron::Linear;
	/*	hidden_layers_activation_function[1] = MultilayerPerceptron::Linear;*/
		break;
	default:
		exit(1);
		break;
...
void MultilayerPerceptron::set_output_layer_activation_function(int index)
{
	switch (index) 
	{
	case 0:
