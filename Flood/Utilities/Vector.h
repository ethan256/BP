...
Vector<Type>::Vector(int new_size)
{
   ...
   if(new_size < 0)
   {
	  TRACE0("Flood Error: Vector Template.\n");
	  TRACE0("Vector(int) constructor.\n");
	  TRACE0("Size must be equal or greater than zero.\n");
      exit(1);
   }
...
Vector<Type> ::Vector(int new_size, const Type& value) 
{
   ...
   {
	  TRACE0("Flood Error: Vector Template.\n");
	  TRACE0("Vector(int, const Type&) constructor.\n");
	  TRACE0("Size must be equal or greater than zero.\n");
      exit(1);
   }
...
inline Type& Vector<Type>::operator [] (int i) 
{
   ...
   {
	  TRACE0("Flood Error: Vector Template. \n");
	  TRACE0("Reference operator [].\n");
	  TRACE0("Size of vector is zero.\n");
      exit(1);
   }
   else if(i < 0)
   {
	  TRACE0("Flood Error: Vector Template. \n");
	  TRACE0("Reference operator [].\n");
	  TRACE0("Index must be equal or greater than zero.\n");
      exit(1);
   }
   else if(i >= size)
   {
	  TRACE0("Flood Error: Vector Template. \n");
	  TRACE0("Reference operator [].\n");
	  TRACE2("Index is %d and it must be less than %d .\n", i, size);
      exit(1);
   }
...
{       
   ...
   {
	  TRACE0("Flood Error: Vector Template.\n");
	  TRACE0("bool operator == (const Vector<Type>&) const.\n");
      exit(1);          
   }
...
{       
   ...
   if(other_size != size)
   {
	  TRACE0("Flood Error: Vector Template.\n");
	  TRACE0("bool operator != (const Vector<Type>&) const.\n");
	  //TRACE2("Size of vectors are %d and %d and they must be the same.\n",i, size);
      exit(1);          
   }
...
{       
   ...
   if(other_size != size)
   {
	  TRACE0("Flood Error: Vector Template.\n");
	  TRACE0("bool operator < (const Vector<Type>&) const.\n");
	  //TRACE2("Size of vector are %d and %d and they must be the same.\n", size, other_size);
      exit(1);          
   }
...
void Vector<Type>::load(const char* filename)
{
   ...
   {
	  TRACE0("Flood Error: Vector template.\n");
	  TRACE0("void load(const char*) method.\n");
	  TRACE0("Cannot open vector XML-type file.\n");
      exit(1);
   }
